...
parser = argparse.ArgumentParser(description='AI_homework')
...
def main():
    ...
    writer = SummaryWriter(comment='youdi123')
    ...
    for epoch in range(args.start_epoch, args.epochs+1):
        ...
        # train for one epoch
        loss,acc=train(train_loader, model, criterion, optimizer, epoch)
        ...
        writer.add_scalar('test_acc', err1, epoch)
